...
citi %>% 
  ...
  ggplot(aes(x = weekdays, y = median_count)) +
  geom_point(aes(size = median_count))
  
citi %>% 
  
  ggplot(aes(x = date, y = median_count)) +
  geom_point(aes(size = median_count))
